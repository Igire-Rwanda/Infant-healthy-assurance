...
function SideMenu(){
    return(
        <div>
            <div className="upper">
             <Oneforprop
              icon ={icon6}name="Dashboard" link='/dashboard'/>
            </div>
            <div className="lower">
                <Oneforprop
                icon ={icon1} name="Home" link='/'/>
                <Oneforprop
                icon ={icon2} name="Broadcast" link='/broadcast'/>
                <Oneforprop
                icon ={icon3} name="Registration" link='/registration'/>
                <Oneforprop
                icon ={icon4} name="Appointment"link='/appointment'/>
                <Oneforprop
                icon={icon7} name="Notification" link='/notification'/>
                <Oneforprop
